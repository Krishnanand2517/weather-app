    ...
    return (
        <div className="my-10">
            ...
            <div className="px-12 md:px-36 lg:px-56 2xl:px-96 py-5 flex items-center justify-center relative">
                <div className="absolute left-0 top-0 w-20 ml-12 md:ml-36 lg:ml-56 2xl:ml-96 h-full bg-gradient-to-r from-sky-light to-transparent transition-opacity duration-800" id="left-gradient"></div>
                <div className="absolute right-0 top-0 w-28 mr-12 md:mr-36 lg:mr-56 2xl:mr-96 h-full bg-gradient-to-l from-sky-light to-transparent transition-opacity duration-800" id="right-gradient"></div>
