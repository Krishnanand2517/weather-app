...
const MainPage = ({ city }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const weatherData = await weatherService.getAll(city);
                const threeHourData = await threeHourService.getAll(city);
                const fiveDaysData = await fiveDaysService.getAll(city);
